 ...
 *
 * @CreateDate 06-Aug-2020 9:54:44 pm
 * @FileNam JWTWebSecurityConfig.java
 */
...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
	 ...
	 * "POST, GET, OPTIONS, DELETE, PUT"); resp.setHeader("Access-Control-Max-Age",
	 * "3600"); resp.setHeader("Access-Control-Allow-Headers",
